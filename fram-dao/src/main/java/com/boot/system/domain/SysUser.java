...
//    @Excel(name = "企业类型", readConverterExp = "0=物流公司,1=货主公司")
	...
	public String toString() {
		return "SysUser [userId=" + userId + ", deptId=" + deptId + ", parentId=" + parentId + ", roleId=" + roleId
				...
				+ phonenumber + ", companyName=" + companyName + ", sex=" + sex + ", avatar=" + avatar + ", password="
				+ password + ", salt=" + salt + ", status=" + status + ", delFlag=" + delFlag + ", loginIp=" + loginIp
				+ ", loginDate=" + loginDate + ", dept=" + dept + ", roles=" + roles + ", roleIds="
				+ Arrays.toString(roleIds) + ", postIds=" + Arrays.toString(postIds) + ", companyAddress="
				+ companyAddress + ", bankName=" + bankName + ", bankCode=" + bankCode + ", businessLicense="
				+ businessLicense + ", roadPermit=" + roadPermit + ", userType=" + userType + ", companyFlag="
				+ companyFlag + ", dangerousCar=" + dangerousCar + ", driverCar=" + driverCar + "]";
	}
